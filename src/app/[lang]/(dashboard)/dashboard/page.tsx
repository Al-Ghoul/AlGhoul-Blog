...
import { authOptions, getBaseUrl } from "@/helpers";
...
const DashboardPage = async () => {
  ...
  const { authors } = await fetchAuthorsWithLanguages().catch(() => ({
    authors: [],
  }));
