...
import type { TopicTranslationType } from '@/helpers/db';
import { editTopicTranslation } from '@/helpers/actions';


const EditTopicTranslationPage = ({ params }: PageProps) => {
    const { data, error, isLoading } = useSWR<TopicTranslationType>(`/api/dashboard/topictranslation/${params.topicId}/${params.languageId}`, fetcher);
