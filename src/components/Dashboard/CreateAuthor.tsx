...
const CreateAuthor = ({ languages, currentUserId, currentUserProfileImage }: Props) => {
    ...
    return (
        <>
            ...
            <form className="flex flex-col mx-auto max-w-screen-sm text-black"
                ...
                <input ref={authorInputRef} className="h-6 rounded-lg bg-blue-200" name="author" type="text" required />
                <label htmlFor="profImgURL" className="text-white">Enter Profile Image URL: </label>
                <input ref={profileURLInputRef} defaultValue={currentUserProfileImage} className="h-6 rounded-lg bg-blue-200" name="profImgURL" type="text" required />
                <label htmlFor="bio" className="text-white">Enter bio: </label>
                <textarea ref={bioInputRef} className="rounded-lg bg-blue-200" name="bio" required />
