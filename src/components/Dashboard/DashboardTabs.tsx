    ...
    tab: {
        ...
        tablist: {
            ...
            styles: {
                ...
                "pills": "flex-wrap font-medium text-sm text-white dark:text-gray-400 space-x-2",
            ...
            tabitem: {
                ...
                "styles": {
                    "default": {
                        "base": "rounded-t-lg",
                        "active": {
                            "on": "backdrop-blur-3xl bg-black/30 text-cyan-200 dark:bg-gray-800 dark:text-cyan-500",
                            "off": "text-white hover:bg-gray-50 hover:text-gray-600 dark:text-gray-400 dark:hover:bg-gray-800  dark:hover:text-gray-300"
                        }
                    },
                    "underline": {
                        "base": "rounded-t-lg",
                        "active": {
                            "on": "text-cyan-200 rounded-t-lg border-b-2 border-cyan-600 active dark:text-cyan-500 dark:border-cyan-500",
